...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~JHnlDjfisacmlFI8d7Fd", // Add sess Id here especially when deploying on panels else use app.json and .env file...
...
OWNER_NAME: process.env.OWNER_NAME || "R.𝐃.V", // Input Yours custom...(Maintain font for Flow)
